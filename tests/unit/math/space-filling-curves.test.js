...
describe('Space-Filling Curves', () => {
    ...
    describe('Hilbert Curves', () => {
        ...
        test('Hilbert curve produces reasonable locality for square queries', () => {
            ...
            const testRegions = [
                [[0, 0], [1, 0], [0, 1], [1, 1]], // corner
                [[2, 2], [3, 2], [2, 3], [3, 3]], // middle
                [[6, 6], [7, 6], [6, 7], [7, 7]]  // far corner
            ];
            
            let hilbertBetter = 0;
            let rowMajorBetter = 0;
            ...
            testRegions.forEach(query => {
                ...
                const rowMajorSpread = Math.max(...rowMajorPositions) - Math.min(...rowMajorPositions);
                
                if (hilbertSpread <= rowMajorSpread) hilbertBetter++;
                else rowMajorBetter++;
            });
