...
// Test configurations
const _SMALL_ARRAY = { sizeX: 32, sizeY: 32, sizeZ: 1 };
const MEDIUM_ARRAY = { sizeX: 128, sizeY: 128, sizeZ: 1 };
const _LARGE_ARRAY = { sizeX: 256, sizeY: 256, sizeZ: 1 };
const _LARGE_3D_ARRAY = { sizeX: 64, sizeY: 64, sizeZ: 16 };
...
testConfigs.forEach(config => {
    ...
    const cellCoord = new CellCoordinate(
        config.arraySize.sizeX,
        config.arraySize.sizeY,
        config.arraySize.sizeZ,
        'hilbert',
        chunkGrid,
        config.chunkSize.x,
        config.chunkSize.y,
